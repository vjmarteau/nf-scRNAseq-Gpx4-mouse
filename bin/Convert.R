...
'
Usage:
  Convert.R --counts_mtx=<counts_mtx> --denoised_mtx=<denoised_mtx> --features=<features> --barcodes=<barcodes> --metadata=<metadata> --metadata_var=<metadata_var> --umap_tsv=<umap_tsv>[options]
